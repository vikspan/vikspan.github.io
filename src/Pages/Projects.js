...
function Projects() {
  const [featured, ...others] = projectDetails;

  return (
    <main className="container mx-auto max-width pt-3 mb-20">
      <section>
        <h1 className="text-center text-2xl text-dark-heading dark:text-light-heading md:text-4xl xl:text-5xl xl:leading-tight font-bold mb-10">
          Projects
        </h1>
        ...
        <div className="flex justify-center mb-10">
          <div className="w-full md:w-4/5 lg:w-4/5">
            <div className="flex flex-col md:flex-row items-stretch bg-white dark:bg-dark-card rounded-xl overflow-hidden shadow-[0_10px_30px_-5px_oklch(70.4%_0.04_256.788)] dark:shadow-slate-900">
              {/* Image half */}
              ...
              {/* Text half */}
              <div className=" md:w-1/2 w-full p-4 md:p-7 md:text-left flex flex-col justify-center dark:bg-dark-card" >
                <h2 className="dark:text-light-heading font-semibold text-xl pt-1">
                  {featured.title}
                </h2>

                <p className="text-content pt-4 font-light">{featured.description}</p>

                <h3 className="text-dark-heading dark:text-light-heading font-medium pt-4">
                  Tech Stack : <span className="font-light">{featured.techstack}</span>
                </h3>

                {/* Links — exact same SVGs / markup / classes as in your Project.js */}
